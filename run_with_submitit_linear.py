...
def parse_args():
    parser = argparse.ArgumentParser("Submitit for MoCov3", parents=[main_lincls.get_args_parser()])
...
def get_shared_folder() -> Path:
    ...
    if Path("/checkpoints/").is_dir():
        p = Path(f"/checkpoints/{user}/experiments/mocov3")
...
def main():
    ...
    executor.update_parameters(name="mocov3")
